...
type VpnNode struct {
	...
	NodeGroupId                     int         `json:"nodeGroupId" gorm:"column:node_group_id"`
	...
	StreamSettingsCongestionControl string      `json:"streamSettingsCongestionControl" gorm:"column:stream_settings_congestion_control"` //
}
